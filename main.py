...
if __name__ == '__main__':
    """
      Victor Vasquez (Bleedmagic)
      Thanks to Andrew Grant (Andrew6rant)
    """
    ...
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 8, 9))
